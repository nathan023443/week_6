...
# my_list=['pie' , '5', 'pear' , 'nana' , 'marvin']
# print(my_list)
# # Lists Practice #2-
...
# transportation_means=["plane", "car", "ship", "bicycle"]
# transportation_means.insert(1,'motorcycle')
...
# fruit_dictionries = {"apple":"red","banana":"yellow","mango":"green","cherry":"red","watermelon": "green"}
# print(fruit_dictionries)
...
# my_dict = {"name":"karen", "surname":"Jurgens", "age":"35", "occuption":"Journalist",}
# my_dick= my_dict.values()
# print(my_dick)
