...
# id_cards={198789, 22345, 763653, 334444, 239585}
# id_cards.pop()
# # print (id_cards)

# id_cards.add(50200817)
# id_cards.add(911)
# print(id_cards)
...
print(tuple2.index('banana')) #gives the index of banana in tuple 2
print(tuple1.index(3)) #gives the indewx of 3 in tuple 1
#convert a tuple to a list
print(list(tuple1)) #turns tuple one into list
#convert a list to a tuple
print(tuple(list(tuple1))) #turns a list into a tuple
